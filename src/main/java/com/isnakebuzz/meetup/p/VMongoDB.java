...
public class VMongoDB implements PlayerDataInterface {
    ...
    private com.isnakebuzz.meetup.a.Main plugin;
    ...
    public VMongoDB(com.isnakebuzz.meetup.a.Main plugin) {
        this.plugin = plugin;
    ...
    public void loadPlayer(Player p) throws IOException {
        ...
        if (com.isnakebuzz.meetup.a.Main.getMode.state == com.isnakebuzz.meetup.a.Main.getMode.SOLO) {
        ...
        } else if (com.isnakebuzz.meetup.a.Main.getMode.state == com.isnakebuzz.meetup.a.Main.getMode.TEAM) {
