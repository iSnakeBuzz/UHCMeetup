...
public class WorldGen extends BukkitRunnable {
    ...
    private void generateNewWorld() {
        ...
        this.isGenerating = true;
        plugin.getServer().dispatchCommand(Bukkit.getConsoleSender(), "wb shape square");
        plugin.getServer().dispatchCommand(Bukkit.getConsoleSender(), "wb " + this.worldname + " set " + plugin.getBorderManager().getBorder() + " 0 0");
        plugin.getServer().dispatchCommand(Bukkit.getConsoleSender(), "wb " + this.worldname + " fill " + plugin.getBorderManager().getBorder());
        plugin.getServer().dispatchCommand(Bukkit.getConsoleSender(), "wb fill confirm");
